...
Route::prefix('mails')->group(function () {
    Route::get('/', [MailsController::class, 'index'])->name('mails');
    Route::get('/list', [MailsController::class, 'list']);
    Route::get('/search', [MailsController::class, 'search']);
    Route::get('/{id}', [MailsController::class, 'show']);
    Route::post('/', [MailsController::class, 'store']);
    Route::post('/reply', [MailsController::class, 'reply']);
    Route::post('/delete', [MailsController::class, 'delete']);
    Route::post('/{id}/star', [MailsController::class, 'star']);
});
